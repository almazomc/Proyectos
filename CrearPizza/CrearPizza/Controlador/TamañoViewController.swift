...
class Taman_oViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if (((cell.textLabel?.text)! as String).isEqual(pizza.tamano)) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        pizza.tamano = tableCell.textLabel?.text as NSString!
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let siguienteVista =  segue.destination as! TipoDeMasaViewController
