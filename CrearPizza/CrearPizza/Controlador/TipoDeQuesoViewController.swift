//
//  TipoDeQuesoViewController.swift
//  CrearPizza
//
...
class TipoDeQuesoViewController: UITableViewController {
    var pizza:Pizza!
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if (((cell.textLabel?.text)! as String).isEqual(pizza.tipoQueso)) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        pizza.tipoQueso = tableCell.textLabel?.text as NSString!
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let siguienteVista =  segue.destination as! IngredientesViewController
